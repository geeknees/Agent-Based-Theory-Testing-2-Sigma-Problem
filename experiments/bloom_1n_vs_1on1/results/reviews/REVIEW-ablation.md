...
- **同じ2条件が毎回 spread の両端に来ていないか確認する**: v9c(37pp)・ablation(25pp)・
  v9c2(10pp)はいずれも pair(n=2)と lecture(n=4)が両端。
  **spread の大小比較は、最小 n の条件の振れを比べているだけかもしれない**
